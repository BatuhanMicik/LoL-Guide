...
//  LoL Guide
//
//  Created by Batuhan Mıcık on 26.04.2022.
//

import Foundation

internal class HttpResponses: Equatable {
    ...
    public static func == (lhs: HttpResponses, rhs: HttpResponses) -> Bool {
        return lhs.code == lhs.code
    }
    
    public static func ==(left: HttpResponses, right: HttpResponses.Codes) -> Bool {
